          ...
          {cocktails.length === 0 ? (
            ...
            <div key={p.id}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem', padding: '1rem 0' }}>
                <div style={{ flex: 1 }}>
                  {p.acf.destacado && (
                    <span style={{ fontSize: '.42rem', letterSpacing: '.2em', color: '#C4693E', textTransform: 'uppercase', display: 'block', marginBottom: '.25rem' }}>
                      ★ Signature
                    </span>
                  )}
                ...
                <p style={{ fontFamily: 'var(--font-cinzel)', fontSize: '.82rem', color: '#C8922A', flexShrink: 0, margin: 0 }}>
                  {p.acf.precio}€
                </p>
              </div>
